...
export function ExpandableCard({ tx }) {
              ...
              <div>
                ...
                >
                  <div className="">
                    ...
                    <motion.p
                      ...
                      className="text-neutral-600 font-normal dark:text-white"
                    >
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-3 text-sm rounded-full font-bold text-white cursor-pointer"
                    onClick={() => setActive(null)}
                    style={{
                      background: "#E74A3B",
                    }}
                ...
                >
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-neutral-800 text-xs md:text-sm lg:text-base h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-400 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                  >
